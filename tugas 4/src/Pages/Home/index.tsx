...
const Home: React.FC = () => {
  ...
  return (
    <S.Page>
      <S.Sidebar>
        ...
        <S.Tabs>
          <SidebarItem
            icon={TaskFill}
            name="Tugas"
            isActive={true}></SidebarItem>
          <ExpandSidebarItem icon={Folder} name="Kategori"></ExpandSidebarItem>
          <SidebarItem
            icon={Settings}
            name="Pengaturan"
            isActive={false}></SidebarItem>
        </S.Tabs>
        <Link
          to="/login"
      ...
      <S.Main>
        <S.Header>Semua Notes</S.Header>
        <S.TitleAndFilter>
          <S.Title onClick={handleDone}>To Do</S.Title>
          <S.FilterField>
            <div onClick={handleAll}>
              <FilterTag name="Semua" active={allActive} />
            </div>
            <div onClick={handleDone}>
              <FilterTag name="Selesai" active={doneActive} />
            </div>
            <div onClick={handleNotDone}>
              <FilterTag name="Belum" active={notDoneActive} />
            </div>
